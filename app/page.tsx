...
export default function Page() {
  return (
    <div className="min-h-screen bg-stone-100 px-4 py-8 sm:px-6 sm:py-12 md:px-12 lg:px-24">
      <div className="max-w-2xl flex flex-col gap-y-6 sm:gap-y-8">
        ...
        <div className="space-y-6 text-base sm:text-lg text-black leading-relaxed">
          <p>
            ...
            development of a forensic acquisition tool that captures and secures
            critical data from target systems. I also plan sprints, building
            solutions to the challenges product brings to the table.
          </p>
          <p>
            ...
            until Darktrace acquired the team.
          </p>
        </div>
